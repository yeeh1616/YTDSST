...
{
    public partial class FrmPopBuyPartialFailure : Form
    {
        int countdown_s = 60;
        public FrmPopBuyPartialFailure()
        {
            InitializeComponent();
        }

        private void FrmPopBuyPartialFailure_Load(object sender, EventArgs e)
        {
            ...
            this.lbAllNum.Text = String.Format("总购彩{0}张", UserContext.getInstance().getBuyLotteryNum().ToString());
        ...
        private void FrmPopBuyPartialFailure_FormClosed(object sender, FormClosedEventArgs e)
        {
